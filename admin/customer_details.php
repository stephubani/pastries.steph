...
if(!isset($_SESSION['customers_loggedin'])){
    $_SESSION['customers_loggedin'] = $customers_logged_in = $admin->checkstatus();
}

// echo '<pre>';
// print_r($_SESSION['customers_loggedin']);
// echo '</pre>';
          ...
          <div class="row stylecol">
            <div class="col-md">
                ...
                <h1>Hello Staff <?php 
                    ...
                    ?>
                you are expected to handle one order at a time</h1>
                <hr>
              </div>
              ...
              <table class=" table table-striped">
                  ...
                  <tbody>
                      <?php
                        foreach( $_SESSION['customers_loggedin'] as $customer){
